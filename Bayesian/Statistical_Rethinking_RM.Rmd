...
# First plot
p_grids <- seq(from = 0, to = 1, length.out = 10000)
priors <- rep(1, 10000)
likelihood <- dbinom(8, size = 15, prob = p_grids)
unstd.posterior1 <- likelihood * priors
posterior <- unstd.posterior1 / sum(unstd.posterior1)
...
simplehist(w, col = "black", lty = 1,
     xlab = "Count of observations", ylab = "Frequency",
     main = "Prior = 1")
...
set.seed(102)
sample3m5 <- sample(p_grid, prob = posterior1, size = 1e4, replace = TRUE)
