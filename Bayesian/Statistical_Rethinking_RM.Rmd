...
![**Figure:50% Percentile interval**- *The posterior density here corresponds to a flat prior and observing three water samples in three total tosses of the globe. This interval assigns equal mass (25%) to both the left and right tail. As a result, it omits the most probable parameter value, p = 1.*](./Png/RM_1.png){width=50%}
...
![**Figure: 50% highest posterior density interval, HPDI**-*This interval finds the narrowest region with 50% of the posterior probability. Such a region always includes the most probable parameter value.*](./Png/RM_2.png){width=50%}
$~$
