...
# Use Laplace's rule of succession- add one to both w and n-w to avoid assigning zero probability, ensure at least there's one w and one n-w, even if none have been observed yet
